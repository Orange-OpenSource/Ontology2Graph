'''This python script merge several knowledge Graphs in an only one. You have to pass as a 
parameter the folder where are stored the Graphs generated by LLM and the number of node's 
occurrence you want to keep in all these files'''
