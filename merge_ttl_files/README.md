...
The TTL merger processes synthetic knowledge graphs generated by LLMs, identifies overlapping entities, and creates merged graphs with configurable node density. It's designed to work with the Ontologie2Graph project for digital twin applications.
...
```bash
python merge_ttl.py --path_file /path/to/synthetic/graphs --ontology ../ontologies/Noria.ttl
```
...
The merger uses the project's common configuration for:
...
- Supports the digital twin knowledge graph pipeline
