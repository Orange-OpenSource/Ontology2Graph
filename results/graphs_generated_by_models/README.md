...
|     Model             |   Consistent with the prompt      |  Number of <br> Classes|  Number of <br> Nodes      |  useable in <br> Protégé   | HermiT <br>Consitency |        ROBOT <br>measurments            |
|:---------------------:|:---------------------------------:|:----------------------:|:--------------------------:|:--------------------------:|:---------------------:|:---------------------------------------:|
|Claude-3.5-sonnet\*    |No, comments                       |            9           |             9              |           yes              |         yes           |          yes, after<br>comment removal  |
|Claude-3.7-sonnet\*    |No, comments + truncated           |           10           |            51              |           yes              |         yes           |          yes, after<br>comment removal  |                       
|Gemini-1.5-flash       |Yes                                |           10           |            10              |           yes              |         yes           |          yes                            |
|Gemini-1.5-pro\*       |No, comments + isolated Nodes      |            8           |            18              |           yes              |         yes           |          yes, after<br>comment removal  |
...
|gpt-4o\*               |No, comments                       |           10           |            24              |           yes              |         yes           |          yes, after<br>comment removal  | 
...
gpt-4.1-nano provide a very specific result by describing first the ontologuy (all the differents kinds of nodes are defined as classes then some  Object properties like 
